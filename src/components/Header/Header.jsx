...
//files
import ReactLogo from "assets/images/header/react-logo.png";
import Arrow from "assets/images/header/down-arrow.svg";
import PortalLogo from "assets/images/header/portal-logo.png";
//styles
  ...
  return (
    <>
      <animated.header
        className="header"
        style={
          !isScrollEvent ? sizeDecrease : { ...sizeDecrease, minHeight: "40px" }
        }
      >
        <$HeaderStart
          subscribe={isScrollEvent}
          refAnimation={refs.bubbleHeader}
